...
namespace Tests.Unit
{
    ...
    {
        [Fact]
        public async Task SendUserInvitationAsync_UsesTemplateAndSettings()
        {
            ...
            var service = new EmailService(clientMock.Object, settingSvc, new ErrorModalService(), templateSvc);
