...
namespace Tests.Unit
{
    public static class InMemorySqliteDbHelper
    {
        ...
        public static async Task<SqliteConnection> CreateOpenDbFromSchemaFileAsync()
        {
            ...
            // Catégories par défaut nécessaires pour les clés étrangères
            await conn.ExecuteAsync("INSERT INTO Category (Id, Name) VALUES (1, 'Onigiris'), (2, 'Desserts');");
            await conn.ExecuteAsync("INSERT INTO Product (Name, Description, Price, CategoryId, IsOnMenu, ImageBase64, IsDeleted) VALUES ('Test', 'desc', 3.5, 1, 1, '', 0);");
            await conn.ExecuteAsync("INSERT INTO Product (Name, Description, Price, CategoryId, IsOnMenu, ImageBase64, IsDeleted) VALUES ('Second', 'desc2', 5, 1, 1, '', 0);");
